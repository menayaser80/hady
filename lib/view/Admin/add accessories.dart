...
class EditOrUploadAccesoriesScreen extends StatefulWidget {
  const EditOrUploadAccesoriesScreen({super.key, this.productModel});
  final Carmodel? productModel;
  @override
  State<EditOrUploadAccesoriesScreen> createState() =>
      _EditOrUploadAccesoriesScreenState();
}

class _EditOrUploadAccesoriesScreenState extends State<EditOrUploadAccesoriesScreen> {
    ...
    if (isValid) {
      try {
        ...
        Fluttertoast.showToast(
          msg: "Accessories has been added",
  ...
  Future<void> _editProduct() async {
    ...
    if (isValid) {
      try {
        ...
        Fluttertoast.showToast(
          msg: "Accessories has been edited",
          textColor: Colors.white,
        );
        if (!mounted) return;
        MyAppFunctions.showErrorOrWarningDialog(
        ...
        child: Scaffold(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(
                      isEditing ? "Edit Accessories" : "Upload Accessories",style: TextStyle(
                      color: Colors.white,
          ...
          appBar: AppBar(
            ...
            title: TitlesTextWidget(
              label: isEditing ? "Edit Accessories" : "Upload Accessories",
            ),
          ),
          body: SafeArea(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextButton(
                                  ...
                                  child: const Text("Pick Accessories Image"),
                                ),
                              ],
                            ),
                          )),
