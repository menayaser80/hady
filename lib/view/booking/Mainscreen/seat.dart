...
class Mainseatwash extends StatefulWidget {
  const Mainseatwash({super.key});

  @override
  State<Mainseatwash> createState() => _MainseatwashState();
}

class _MainseatwashState extends State<Mainseatwash> {
    ...
    return wishlistProvider.getProducts.isEmpty
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Image.asset('assets/images/seats cleanning.jpeg',
            ),
            Text(
              'Empty Seatwash',
              style: TextStyle(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: TitlesTextWidget(label: "SeatWash"),
      ),
