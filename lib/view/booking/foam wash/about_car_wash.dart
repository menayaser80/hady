...
import 'package:lava/view/booking/foam%20wash/booking_page.dart';
...
class Foamwashpage extends StatefulWidget {
  const Foamwashpage({super.key});

  @override
  State<Foamwashpage> createState() => _ActionBookingPageState();
}

class _ActionBookingPageState extends State<Foamwashpage> {
