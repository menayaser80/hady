...
import 'package:lava/view/booking/polish%20serface/booking_page.dart';
...
class Polishpage extends StatefulWidget {
  const Polishpage({super.key});

  @override
  State<Polishpage> createState() => _ActionBookingPageState();
}

class _ActionBookingPageState extends State<Polishpage> {
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  CustomText(
                    text: 'Polishing the car serface',
                    fontSize: 18,
