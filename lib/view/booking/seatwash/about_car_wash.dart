...
import 'package:lava/view/booking/seatwash/booking_page.dart';
...
class Seatwashpage extends StatefulWidget {
  const Seatwashpage({super.key});

  @override
  State<Seatwashpage> createState() => _ActionBookingPageState();
}

class _ActionBookingPageState extends State<Seatwashpage> {
