...
import 'package:lava/view/booking/steam%20wash/booking_page.dart';
...
class Staemwashpage extends StatefulWidget {
  const Staemwashpage({super.key});

  @override
  State<Staemwashpage> createState() => _ActionBookingPageState();
}

class _ActionBookingPageState extends State<Staemwashpage> {
