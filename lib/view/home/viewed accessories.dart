...
class Viewedaccscreen extends StatelessWidget {
  static const routName = "/ViewedRecentlyaccScreen";
  const Viewedaccscreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return viewedProdProvider.getViewedProds.isEmpty
      ...
      body: EmptyBagWidget(
        ...
        title: "No viewed Accessories yet",
        subtitle:
